...
Bot Telegram berbasis Python yang **modular**, **bersih**, dan **siap production**. Dibangun dengan arsitektur terpisah antar file — bukan spaghetti code yang malu-maluin. Setiap file punya tugasnya sendiri. Setiap command punya handler-nya sendiri. **Zero toleration untuk kode berantakan.**
